...
txt_gpl=$txt_gpl' installed Ubuntu with no extra packages. \n\n'
txt_gpl=$txt_gpl' If you selected additional options during the Ubuntu \n'
...
txt_mysqlrootpassword="Mot de Passe Root MySQL"
