...
gpl=' Bienvenue sur l installateur officiel de ZPaneX pour Ubuntu 12.04 \n\n'
...
gpl=$gpl' Ubuntu sans paquets supplémentaires. \n\n'
gpl=$gpl' Si vous avez sélectionné des options supplémentaires au cours de l installation de Ubuntu \n'
